...
const Works = () => {
  ...
  const text = `Selected products built around real business needs—
    conversion, performance, maintainability,
  ...
  return (
    <section id="work" className="flex flex-col min-h-screen">
      <AnimatedHeaderSection
        subTitle={"Selected product work · live and in production"}
        title={"Works"}
        text={text}
